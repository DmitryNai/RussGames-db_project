...
// CreatePurchase — creates transaction + purchase + assigns license + adds to library in a transaction
func CreatePurchase(db *gorm.DB) gin.HandlerFunc {
    ...
    return func(c *gin.Context) {
        ...
        err := db.Transaction(func(tx *gorm.DB) error {
            // set current user for triggers (SET LOCAL) — using raw SQL
